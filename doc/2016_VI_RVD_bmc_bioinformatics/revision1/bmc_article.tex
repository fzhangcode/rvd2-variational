...
%The source code could be found via the link below \url{http://genomics.wpi.edu/vi_rvd/}.
...
\caption{ROC cures with varying median read depths and NRAFs.}%\label{figure:roc}
\end{figure}
