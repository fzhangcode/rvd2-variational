...
We detected XXX variants (NRAF $<$ 1.0\%) early in the evolutionary time course.
Given that the median read depth is XXX, we have some confidence these are bona-fide variants.
%TODO: Fill in these XXX numbers
