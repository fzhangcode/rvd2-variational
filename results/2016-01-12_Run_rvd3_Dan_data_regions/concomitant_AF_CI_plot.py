...
def main():
    ...
    plt.plot(ind, AF_all, linestyle='-', linewidth=12, marker='o', markersize=16, color='b', label='Chr04:1,014,740')
    ...
    plt.plot(ind, AF_all, linestyle='-', linewidth=12, marker='o', markersize=16, color='r', label='Chr12:200,286')
